  ...
  const posts = [
    ...
    },
    {
      ...
      description:
        ...
        link: "https://en.wikipedia.org/wiki/Annie_Besant" ,
    },
    {
      id: 8,
      image: "e.jpg",
      title: "Kamala Nehru : The Brave Activist",
      description:
        ...
        link: "https://en.wikipedia.org/wiki/Kamala_Nehru" ,
    },
    {
      id: 9,
      image: "b.jpg",
      title: "Bhikaji Cama : The Flag Bearer of Independence",
      description:
        "Bhikaji Cama was an early revolutionary and staunch advocate for India's independence, playing a crucial role in mobilizing support from abroad. In 1907, she unfurled the first version of the Indian flag at an international socialist conference in Germany. From exile in Europe, she fought for India's independence by writing articles and rallying support from the Indian diaspora. Her activism made her one of the most prominent figures in the international movement for Indian independence, and she is revered as one of the foremothers of the Indian national flag.",
        link: "https://en.wikipedia.org/wiki/Bhikaiji_Cama" ,
    },
    {
      id: 10,
      image: "f.jpg",
      title: "Durgabai Deshmukh : The Social Reformer",
      description:
        "Durgabai Deshmukh actively participated in the Non-Cooperation Movement and the Salt Satyagraha. She organized women's groups and protests against British rule and later worked toward the rehabilitation of Indian refugees after independence. An advocate for women's education, she founded several institutions and became a member of the Constituent Assembly of India. She established the Andhra Mahila Sabha to support women's welfare and education. Post-independence, she played a vital role in legal and social reforms in the new republic.",
        link: "https://en.wikipedia.org/wiki/Durgabai_Deshmukh" ,
    },
  ];
