...
const Carousel4 = () => {
  ...
  const posts = [
    ...
    },
    {
      ...
      title: "Tessy Thomas  ",
      description:
        "Dr. Tessy Thomas, often referred to as the Missile Woman of India, is a prominent Indian scientist and aerospace engineer. She is best known for her pivotal role in the development of the Agni series of ballistic missiles as part of India’s Defence Research and Development Organisation (DRDO). Dr. Thomas made history by becoming the first woman to head an Indian missile project, serving as the project director for Agni-IV and later as the director general of aeronautical systems. Her contributions to India's defense capabilities have earned her widespread recognition and prestigious awards, making her an inspiration for women in science and technology. ",
      link: "https://en.wikipedia.org/wiki/Tessy_Thomas",
    },
    {
      id: 5,
      image: "g4.jpg",
      title: "Kamal Ranadive ",
      description:
